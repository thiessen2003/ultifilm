export interface Play {
  ...
  tracking_data: string | null       // JSON keyframes for player tracking
  created_at: string
}

export type CreatePlayInput = Omit<Play, 'id' | 'created_at' | 'drawing_data' | 'video_drawing_data' | 'tracking_data'>
